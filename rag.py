...
TOKEN = "7877029366:AAEYVf0qcQaRqiLq5zV5Ze0k8tSpmL7Lu5Y"  # Replace with your bot token
ADMIN_ID = 5906186379  # Your admin ID
...
def start_attack(call):
    ...
    full_command = f"./SOULCRACK {ip} {port} {duration} CRACKS"
